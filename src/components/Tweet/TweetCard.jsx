        ...
        <>
            <div className='p-6 cursor-pointer hover:bg-gray-100 relative '>
                ...
                <footer className='p-5 px-8 flex gap-6'>
                    ...
                    <div onClick={() => { copy(`${API_BASE_URL}/tweet/${tweet._id}`) }} className='flex gap-2 items-center text-gray-700 group hover:text-twitter-100 cursor-pointer w-fit transition-all duration-300'>
                ...
                <SmallModal position={'right-2'} isOpen={isOptionOpen} onClose={closeOptionModal} >
                    <div className='py-2 space-y-3 '>
                        ...
                        <div onClick={() => copy(`${API_BASE_URL}/tweet/${tweet._id}`)} className='hover:bg-gray-200 px-2 rounded flex gap-2 items-center text-twitter-100'><IoIosShareAlt /> Share Tweet</div>
                    </div>
                </SmallModal>
            </div>
